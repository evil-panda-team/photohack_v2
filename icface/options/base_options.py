...
#        self.parser.add_argument('--ndf', type=int, default=64, help='# of discrim filters in first conv layer')
        self.parser.add_argument('--ndf', type=int, default=256, help='# of discrim filters in first conv layer')
...
#        self.parser.add_argument('--name', type=str, default='experiment_name', help='name of the experiment. It decides where to store samples and models')
        self.parser.add_argument('--name', type=str, default='gpubatch_resnet', help='name of the experiment. It decides where to store samples and models')
...
#        self.parser.add_argument('--no_flip', action='store_true', help='if specified, do not flip the images for data augmentation')
        self.parser.add_argument('--no_flip', type=bool, default=True, help='if specified, do not flip the images for data augmentation')
