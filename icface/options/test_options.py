...
#        self.parser.add_argument('--input_img', type=str, default='./img/rafa.png', help='input image')
        self.parser.add_argument('--input_img', type=str, default='path/to/img/', help='input image')
...
#        self.parser.add_argument('--results_dir', type=str, default='./results/', help='saves results here.')
        self.parser.add_argument('--results_dir', type=str, default='new_crop/results_video', help='saves results here.')
...
#        self.parser.add_argument('--which_ref', type=str, default='path/to/reference/image', help='path to customized reference image')
        self.parser.add_argument('--which_ref', type=str, default='temp.png', help='path to customized reference image')
...
#        self.parser.add_argument('--csv_path', type=str, default='path/to/csv/driving', help='path to csv file containing AUs of driving video')
        self.parser.add_argument('--csv_path', type=str, default='path/to/csv/', help='path to csv file containing AUs of driving video')
